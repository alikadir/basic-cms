...
public partial class Yonetim_Duyurular : System.Web.UI.Page
{
    ...
    protected void BtnKaydet_Click(object sender, EventArgs e)
    {
        ...
        { // kaydet
            ...
            if ("-1" == AKBclass.DBMudahale.SQLIsle("INSERT INTO Duyurular_Tbl(Baslik,Aciklama,Etiket) VALUES (@Baslik,@Aciklama,@Etiket)", pCollection))
        ...
        { // güncelle
            ...
            if ("-1" == AKBclass.DBMudahale.SQLIsle("UPDATE Duyurular_Tbl SET Baslik = @Baslik,Aciklama = @Aciklama,Etiket = @Etiket WHERE ID = @ID", pCollection))
    ...
    void Doldur(string ID)
    {
        ...
        {
            Hashtable ht = AKBclass.DBMudahale.TekKayitDondurHT("Duyurular_Tbl", "Baslik,Aciklama,Etiket", "WHERE ID = " + ID);
 ...
 BtnKaydet.Text = "Güncelle";
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        { // sil
            AKBclass.DBMudahale.SQLIsle("DELETE FROM Duyurular_Tbl WHERE ID = " + e.CommandArgument.ToString());
